package com.zjlh.villa.service.util.message.lib;

import com.zjlh.villa.service.util.message.lib.base.ISender;
import com.zjlh.villa.service.util.message.lib.base.SenderWapper;
import com.zjlh.villa.service.util.message.config.AppConfig;
import com.zjlh.villa.service.util.message.config.MailConfig;
import com.zjlh.villa.service.util.message.config.MessageConfig;
